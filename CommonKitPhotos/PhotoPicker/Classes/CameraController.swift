...
extension CameraController {
    ...
    @objc open func rotated() {
        ...
        if ( self.previewLayer?.connection?.isVideoOrientationSupported ?? false ) {
            ...
            self.previewLayer?.connection?.videoOrientation = (UIApplication.shared.windows.first?.windowScene?.interfaceOrientation.isLandscape ?? false ) ? AVCaptureVideoOrientation.landscapeLeft : AVCaptureVideoOrientation.portrait
        }
